    ...
    return (
        <div className="App container">
            ...
            <div className="bg-gray-200 p-4 block h-screen content-center align-middle">
                ...
                <button className="btn btn-blue" onClick={null}>Make it from scratch</button>
                <button className="btn btn-blue" onClick={null}>Make it from my linkedin profile</button>
                </div>
            </div>
        </div>
    );
